...
function CountryBox({ code, selected, onClick }: { code: string; selected: boolean; onClick: () => void }) {
  return (
    <div
      onClick={onClick}
      className={`cursor-pointer relative rounded-[6px] flex items-center justify-center py-[6px] ${selected ? "bg-[#434343]" : "bg-white"}`}
      style={{ width: 110 }}
    >
      <div
        aria-hidden
      ...
      />
      <p className={`font-['Inter:Medium',sans-serif] font-medium text-[14px] leading-[21px] whitespace-nowrap ${selected ? "text-white" : "text-[#434343]"}`}>
        {code}
      </p>
    </div>
  );
  ...
  return (
    <div className="bg-white shrink-0 w-full" style={{ minHeight: 89 }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="flex items-center justify-between py-[24px] px-8 relative w-full max-w-[1100px] mx-auto">
          <div className="flex gap-[12px] h-[56px] items-center shrink-0 w-[294.891px]">
            ...
            <div className="flex-[1_0_0] h-[56px] min-w-px relative">
              <div className="flex flex-col items-start relative size-full">
                <div className="h-[36px] relative shrink-0 w-full">
                  <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] left-0 not-italic text-[#434343] text-[24px] top-0 tracking-[0.0703px] whitespace-nowrap">
                    Marketplace Matching
                  </p>
                </div>
                <div className="h-[20px] relative shrink-0 w-full">
                  <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#434343] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">
                    Mercury team project
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex h-[32px] items-center shrink-0">
            <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic shrink-0 text-[#434343] text-[14px] tracking-[-0.1504px] whitespace-nowrap">
              Ingersoll Rand
            </p>
          </div>
        </div>
...
function QuestionCard({ n, title, subtitle, children }: {
  ...
  return (
    <div className="bg-white w-full rounded-[14px] relative">
      ...
      <div className="flex flex-col gap-[20px] p-[24px] relative">
        <div className="flex flex-col gap-[4px]">
          <div className="flex items-center gap-[12px]">
            <NumberBadge n={n} />
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[18px] text-[#434343] leading-[25px]">{title}</p>
          </div>
      ...
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col gap-[24px] items-start py-[32px] w-full max-w-[1100px] mx-auto px-8">
          ...
          <div className="flex flex-col gap-[8px] items-start shrink-0 w-full">
            <p className="font-['Inter:Bold',sans-serif] font-bold text-[30px] text-[#434343] tracking-[0.3955px] leading-[36px]">
          ...
          <div className="flex items-center justify-between w-full py-[4px]">
            ...
            <div
              onClick={onBack}
              className="relative cursor-pointer min-h-[44px] rounded-[8px] shrink-0 flex items-center"
            >
            ...
            <div
              ...
              className={`min-h-[44px] relative rounded-[8px] shrink-0 transition-opacity ${
                isFormComplete
