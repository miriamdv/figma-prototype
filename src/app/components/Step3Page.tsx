    ...
    <div className="bg-white shrink-0 w-full" style={{ minHeight: 89 }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex flex-col md:flex-row md:items-center md:justify-between gap-y-1 py-[24px] px-4 md:px-6 lg:px-8 relative w-full max-w-[1100px] mx-auto">
          ...
          <div className="content-stretch flex items-center relative shrink-0 order-first self-end md:order-none md:self-auto md:h-[32px]">
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-sm text-gray-400 md:text-[14px] md:text-[#434343] tracking-[-0.1504px] whitespace-nowrap">Ingersoll Rand</p>
          </div>
        </div>
      </div>
    </div>
...
function AnalysisSummarySection() {
  ...
  return (
    <div className="bg-white drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] relative rounded-[10px] shrink-0 w-full overflow-hidden">
      <div className="content-stretch flex flex-col items-start p-[24px] relative size-full">
        ...
        <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
          ...
          <button
            onClick={() => setOpen(v => !v)}
            className="content-stretch flex items-center justify-center min-h-[32px] min-w-[32px] p-[8px] relative rounded-[6px] shrink-0 cursor-pointer border border-transparent hover:border-[#e0e0e0] transition-colors"
            aria-label={open ? "Collapse" : "Expand"}
          >
            <div className="relative shrink-0 size-[18px]" style={{ transition: "transform 0.25s ease", transform: open ? "rotate(0deg)" : "rotate(180deg)" }}>
              <div className="absolute inset-0">
                <div
...
function MarketplaceScoreCard({ rank, name, tag, status, score, scoreLabel, scoreColor, countries, barFill, onDetails }: ScoreCardProps) {
  return (
    <div className="bg-white drop-shadow-[0px_3px_5px_rgba(0,0,0,0.15)] w-full relative rounded-[14px]">
      ...
      <div className="content-stretch flex flex-col gap-[18px] items-start pb-[16px] pt-[24px] px-[24px] relative size-full">
        ...
        <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col items-end relative shrink-0 w-full">
            <div onClick={onDetails} className="bg-transparent content-stretch flex gap-[2px] items-center justify-center min-h-[32px] px-[8px] py-[2px] relative rounded-[6px] shrink-0 cursor-pointer hover:bg-black/5">
...
function TopMarketplaceMatchesSection({ onDetails }: { onDetails: (index: number) => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[16px] w-full">
        {LIST_ITEMS.slice(0, 3).map((item, idx) => (
          <MarketplaceScoreCard
            ...
            scoreLabel={item.fitLabel}
            scoreColor={item.scoreColor}
            countries="UK | DE | FR"
            barFill={item.scoreValue}
...
function EntryStrategyCTA({ title, description }: { title: string; description: React.ReactNode }) {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] relative rounded-[10px] shrink-0 w-full">
      <div className="content-stretch flex flex-col md:flex-row items-start md:items-center gap-4 p-[24px] relative size-full">
        ...
        <div className="bg-[#d42a1d] content-stretch flex gap-[4px] items-center justify-center min-h-[44px] px-[12px] py-[10px] relative rounded-[8px] shrink-0 cursor-pointer w-full md:w-auto">
...
function AllMarketplacesSection({ selectedIndex, setSelectedIndex, panelRef }: {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[24px] py-[24px] w-full">
      {/* Left: list */}
      <div className="bg-white content-stretch flex flex-col gap-[31px] items-start p-[24px] relative rounded-[14px] shrink-0 w-full lg:w-[457px]">
        <div aria-hidden className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[14px]" />
        {/* Section header */}
      ...
      {/* Right: analysis */}
      <div ref={panelRef} className="scroll-mt-4 min-w-0 flex-1">
  ...
  return (
    <div className="bg-[#f5f5f5] relative rounded-[14px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start pb-[25px] pt-[25px] px-[25px] relative size-full">
        ...
        {/* Stat cards */}
        <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-1 sm:grid-cols-3 relative shrink-0 w-full">
          {[
            { value: "5",   label: "Strong matches" },
            { value: "78%", label: "Top match score" },
            { value: "3",   label: "Priority markets" },
          ].map(stat => (
            <div key={stat.label} className="bg-white drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] relative rounded-[10px]">
              <div className="flex flex-col gap-[4px] items-start p-[16px]">
  ...
  return (
    <div className="bg-[#f5f5f5] relative rounded-[14px] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[24px] items-center p-[24px] relative size-full">
        {/* Header row */}
        <div className="content-stretch flex flex-wrap items-center justify-between gap-3 relative shrink-0 w-full">
          <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
            <div className="bg-[#d42a1d] content-stretch flex flex-col items-center justify-center relative rounded-[10px] shrink-0 size-[36px]">
              <div className="relative shrink-0 size-[24px]">
                <div
...
export default function Step3Page({ onBack }: { onBack: () => void }) {
  ...
  const allMarketplacesRef = useRef<HTMLDivElement>(null);
  ...
  const handleDetails = (index: number) => {
    ...
    allMarketplacesRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
    ...
    <div className="bg-[#f9fafb] flex flex-col items-start min-h-full w-full overflow-x-hidden">
      ...
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col gap-[24px] items-start py-[32px] w-full max-w-[1100px] mx-auto px-4 md:px-6 lg:px-8">
          ...
          {/* Page header */}
          <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
            <p className="font-['Inter:Bold',sans-serif] font-bold not-italic text-[#434343] text-xl md:text-[30px] leading-tight md:leading-[36px] tracking-[0.3955px]">Marketplace Analysis Results</p>
          ...
          <TopMarketplaceMatchesSection onDetails={handleDetails} />
          ...
          <div ref={allMarketplacesRef} className="w-full scroll-mt-4">
            <AllMarketplacesSection selectedIndex={selectedIndex} setSelectedIndex={setSelectedIndex} panelRef={panelRef} />
          </div>
          <KeyInsightsSection />
