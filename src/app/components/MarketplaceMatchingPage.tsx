  ...
  return (
    <div className="bg-white shrink-0 w-full" style={{ minHeight: 89 }}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex flex-col md:flex-row md:items-center md:justify-between gap-y-1 py-[24px] px-4 md:px-6 lg:px-8 relative w-full max-w-[1100px] mx-auto">
          ...
          <div className="flex items-center shrink-0 order-first self-end md:order-none md:self-auto md:h-[32px]">
            <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic shrink-0 text-sm text-gray-400 md:text-[14px] md:text-[#434343] tracking-[-0.1504px] whitespace-nowrap">Ingersoll Rand</p>
          </div>
        </div>
      </div>
    </div>
...
function PageMeta() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Bold',sans-serif] font-bold not-italic text-[#434343] text-xl md:text-[30px] leading-tight md:leading-[36px] tracking-[0.3955px]">Review Extracted Brand Profile</p>
      <div className="flex flex-wrap gap-x-[2px] gap-y-[4px] items-center w-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic shrink-0 text-[#434343] text-[16px] whitespace-nowrap">{`We analyzed `}</p>
        <div className="bg-[#e0e0e0] flex items-start px-[4px] py-[2px] rounded-[4px] min-w-0 max-w-full overflow-hidden">
          <p className="font-['Menlo:Regular',sans-serif] leading-[20px] not-italic text-[#434343] text-[14px] truncate">{`https://uat-shop.welchvacuum.com/en-us/industries`}</p>
        </div>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic shrink-0 text-[#434343] text-[16px] whitespace-nowrap">. Review and edit any fields before scoring.</p>
      </div>
    </div>
  );
}
...
function BrandProfileSection() {
  return (
    <div className="bg-white relative rounded-[14px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start p-3 md:px-[17px] md:py-[25px] relative size-full">
        {/* SectionHeader */}
        <div className="relative shrink-0 w-full">
...
function ProductCategorySection() {
  return (
    <div className="bg-white relative rounded-[14px] self-stretch shrink-0 w-full">
      <div aria-hidden className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="content-stretch flex flex-col items-start gap-[16px] p-3 md:p-[25px] relative size-full">
        {/* SectionHeaderRow */}
        <div className="relative shrink-0 w-full">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 w-full">
            ...
            <div className="bg-[#e6f3ef] h-[25px] relative rounded-[9999px] shrink-0 w-fit">
        ...
        <div className="mt-auto w-full"><KeyHints /></div>
      </div>
    </div>
  );
}
      ...
      <div className="content-stretch flex flex-col items-start gap-[16px] p-3 md:p-[25px] relative size-full">
        ...
        <div className="relative shrink-0 w-full">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 w-full">
            ...
            <div className="flex-1 min-w-0" />
            <div className="bg-[#e6f1fb] h-[25px] relative rounded-[9999px] shrink-0 w-fit">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[8px] py-[2px] relative size-full">
                <div className="content-stretch flex h-full items-center relative shrink-0">
      ...
      <div className="content-stretch flex flex-col items-start gap-[16px] p-3 md:p-[25px] relative size-full">
        ...
        <div className="relative shrink-0 w-full">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 w-full">
            ...
            <div className="flex-1 min-w-0" />
            <div className="bg-[#e6f3ef] relative rounded-[9999px] shrink-0 w-fit">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center justify-center px-[8px] py-[2px] relative size-full">
                <div className="content-stretch flex items-center relative shrink-0">
                  <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#00855d] text-[14px] whitespace-nowrap">{` 80% Confident`}</p>
                </div>
        ...
        <div className="mt-auto w-full"><RadioGroup options={["Budget", "Mid-Range", "Premium"]} defaultValue="Mid-Range" /></div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[14px] self-stretch shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col items-start gap-[16px] p-3 md:p-[25px] relative size-full">
        ...
        <div className="mt-auto w-full"><RadioGroup options={["Low Tech", "Medium Tech", "High Tech"]} defaultValue="High Tech" /></div>
      </div>
    </div>
  );
}
...
function CompetitorsIdentifiedSection() {
  return (
    <div className="bg-white relative rounded-[14px] shrink-0 w-full">
      <div aria-hidden className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="content-stretch flex flex-col gap-[32px] items-start p-3 md:p-[25px] relative size-full">
...
function ExtractionNotesBlock() {
  return (
    <div className="bg-[#e6f1fb] border border-[#5088b4] rounded-[14px] w-full p-4">
      <div className="flex gap-[8px] items-start">
        <div className="shrink-0 w-[20px] mt-[2px]">
          <svg width="20" height="22" viewBox="0 0 20 22" fill="none">
            <path d={svgPaths.p29b1f900} stroke="#434343" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            <path d="M7.5 17H12.5" stroke="#434343" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            <path d="M8.33333 20H11.6667" stroke="#434343" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
        <div className="flex flex-col gap-[4px] min-w-0">
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[27px] text-[#434343] text-[18px] tracking-[-0.4395px]">Extraction Notes</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] text-[#434343] text-[14px] tracking-[-0.1504px]">Product categories were inferred from the specific products listed; customer types are based on the industries targeted. Price and technology positioning is inferred but aligns with their specialized offerings and general market perception.</p>
        </div>
      </div>
    </div>
  );
...
function BottomActions({ onConfirm }: { onConfirm: () => void }) {
  return (
    <div className="flex items-center justify-end w-full mt-0 md:mt-0">
      <div className="bg-[#d42a1d] min-h-[44px] relative rounded-[8px] shrink-0 cursor-pointer w-full md:w-auto" onClick={onConfirm}>
  ...
  return (
    <div className="bg-[#f9fafb] flex flex-col items-start min-h-full w-full overflow-x-hidden">
      ...
      <div className="flex flex-col items-center w-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start py-[32px] relative w-full max-w-[1100px] mx-auto px-4 md:px-6 lg:px-8">
          <Breadcrumbs />
          <PageMeta />
          <BrandProfileSection />
          <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-1 md:grid-cols-2 relative shrink-0 w-full">
